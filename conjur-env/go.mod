...
replace golang.org/x/net v0.0.0-20220923203811-8be639271d50 => golang.org/x/net v0.10.0
...
replace golang.org/x/text v0.9.0 => golang.org/x/text v0.9.0
...
replace golang.org/x/sys v0.3.0 => golang.org/x/sys v0.8.0
